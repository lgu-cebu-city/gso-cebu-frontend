...
@Component({
  selector: 'app-print-preview-aob',
  templateUrl: './print-preview-aob.component.html',
  styleUrls: ['./print-preview-aob.component.css']
})
export class PrintPreviewAobComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PrintPreviewAobComponent>,
  ) { }
