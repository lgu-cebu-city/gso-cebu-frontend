...
@Component({
  selector: 'app-iar-list-selection',
  templateUrl: './iar-list-selection.component.html',
  styleUrls: ['./iar-list-selection.component.css']
})
export class IarListSelectionComponent implements OnInit {
  ...
  displayedColumnsItemDetails: string[] = ['description', 'brand', 'uom', 'quantity', 'serialNo', 'check'];
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<IarListSelectionComponent>,
  ) { }
  ...
  loadData() {
    this.httpRequest.getAllAcceptanceAndInspectionReportARE().subscribe((result) => {
