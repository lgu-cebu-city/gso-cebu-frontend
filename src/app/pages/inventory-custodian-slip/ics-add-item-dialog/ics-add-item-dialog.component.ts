...
import { InventoryCustodianSlipComponent, DialogData } from '../inventory-custodian-slip.component';

@Component({
  selector: 'app-ics-add-item-dialog',
  templateUrl: './ics-add-item-dialog.component.html',
  styleUrls: ['./ics-add-item-dialog.component.css']
})
export class IcsAddItemDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<InventoryCustodianSlipComponent>,
