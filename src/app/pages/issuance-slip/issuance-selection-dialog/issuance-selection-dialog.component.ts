...
@Component({
  selector: 'app-issuance-selection-dialog',
  templateUrl: './issuance-selection-dialog.component.html',
  styleUrls: ['./issuance-selection-dialog.component.css']
})
export class IssuanceSelectionDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<IssuanceSlipComponent>,
  ) { }
