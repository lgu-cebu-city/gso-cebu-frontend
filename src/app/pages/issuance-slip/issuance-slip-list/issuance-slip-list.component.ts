...
@Component({
  selector: 'app-issuance-slip-list',
  templateUrl: './issuance-slip-list.component.html',
  styleUrls: ['./issuance-slip-list.component.css']
})
export class IssuanceSlipListComponent implements OnInit {
  ...
  createFn() {
    const dialogRef = this.dialog.open(IssuanceSlipComponent, {panelClass: 'custom-dialog-container'},);
  ...
  editFn() {
    const dialogRef = this.dialog.open(IssuanceSlipComponent, {panelClass: 'custom-dialog-container', data: {
