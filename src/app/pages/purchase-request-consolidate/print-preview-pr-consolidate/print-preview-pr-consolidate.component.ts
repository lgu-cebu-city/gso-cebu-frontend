...
@Component({
  selector: 'app-print-preview-pr-consolidate',
  templateUrl: './print-preview-pr-consolidate.component.html',
  styleUrls: ['./print-preview-pr-consolidate.component.css']
})
export class PrintPreviewPrConsolidateComponent implements OnInit {
  selectedPR: PurchaseRequestModel = null;
  selectedPRItemsPrint: PurchaseRequestItemsModel[][] = [];

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    private dialogRef: MatDialogRef<PrintPreviewPrConsolidateComponent>,
  ) { }
