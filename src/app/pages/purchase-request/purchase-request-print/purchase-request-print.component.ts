...
@Component({
  selector: 'app-purchase-request-print',
  templateUrl: './purchase-request-print.component.html',
  styleUrls: ['./purchase-request-print.component.scss']
})
export class PurchaseRequestPrintComponent implements OnInit {
