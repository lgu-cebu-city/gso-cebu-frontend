...
import { DialogData } from '../../request-quotation.component';

@Component({
  selector: 'app-rfq-list-items',
  templateUrl: './rfq-list-items.component.html',
  styleUrls: ['./rfq-list-items.component.css']
})
export class RfqListItemsComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<RfqListItemsComponent>,
  ) { }
