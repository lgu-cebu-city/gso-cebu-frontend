...
export class NonInventoryItemItemXLSX {
  numberFormat = Intl.NumberFormat('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
  constructor() {}

  public generateXLSXFormat(data: Item[]) {
    let workbook = new Workbook();
    let worksheet = workbook.addWorksheet("Non-Inventory Item Master");
    ...
    worksheet.getCell('A2').value = 'NON-INVENTORY ITEM MASTER';
